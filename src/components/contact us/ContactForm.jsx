...
const ContactForm = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#e6dfda] font-sans px-4 py-8">
      <div className="bg-[#d2aaaa] p-8 rounded-[2rem] shadow-lg w-full max-w-3xl relative">
        ...
        <form className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-[#3d1f2a] font-playpen">
          {/* Name */}
          <div>
            <label>Name</label>
            <input
          ...
          <div>
            ...
            <div className="mt-1 border border-black rounded-xl p-2 font-poppins">
              {[
                "Venue Decoration",
                "Photography",
                "Catering Services",
                ...
                <div key={service} className="flex items-center space-x-2 py-1">
                  <input type="checkbox" className="accent-[#3d1f2a]" />
